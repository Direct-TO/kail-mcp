...
# Maps registered MCP tool names to the binary or file they require.
# Keep this list aligned with ToolRegistry._build(); legacy-only entries make
# startup availability numbers misleading without exposing more MCP tools.
